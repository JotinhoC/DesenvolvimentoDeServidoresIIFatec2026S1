...
<html lang="pt-br">
    <head>
        ...
        <title>Login - Sistema de Mapa de Sala</title>
        ...
        <link rel="stylesheet" href="../../ProjetoReservaSala/assets/css/stylePassword.css">
        ...
        <div class="container">
            <!-- Logo acima do formulário -->
             <div class="text-center">
                <img src="../../ProjetoReservaSala/assets/img/logo_fatecSR.png" alt="Logo da Empresa" style="max-width: 200px;
                         margin-bottom: 20px;">
             </div>
                ...
                <form autocomplete="off" id="login">
                    <fieldset>
                        <div class="form-group">
                            <input class="form_control" placeholder="Usuário" id="txtUsuario" name="txtUsuario"
...
<script src="../../ProjetoReservaSala/assets/js/bootstrap.min.js"></script>
<script src="../../ProjetoReservaSala/assets/js/sweetalert2.all.min.js"></script>
