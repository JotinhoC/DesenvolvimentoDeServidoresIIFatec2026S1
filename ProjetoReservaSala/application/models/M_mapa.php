...
class M_mapa extends CI_Model{
    ...
    0 - Erro de exceção
    1 - Operação realizada no banco de dados com sucesso (inserção, alteraçãom consulta ou exclusão)
    ...
    */
    ...
    public function inserir($dataReserva, $codSala, $codHorario, $codTurma, $codProfessor){
        try{
            //Verifico se a reserva já esta cadastrada
                    ...
                    if ($retornoConsultaHorario['codigo'] == 10){
                        ...
                        if ($retornoConsultaTurma['codigo'] == 10){
                            ...
                            if($retornoConsultaProfessor['codigo'] == 1){
                                ...
                                $this->db->query(
                                    "insert into tbl_mapa (datareserva, sala, codigo_horario, codigo_turma, codigo_professor)
        ...
        try{
            ...
            if ($retornoConsultaCodigo['codigo'] == 1){
                ...
                if ($codSala != ""){
                    ...
                    //chamar o metodo para verificação
                    $retornoConsultaSala = $salaObj->consultar($codSala, '', '', '');
