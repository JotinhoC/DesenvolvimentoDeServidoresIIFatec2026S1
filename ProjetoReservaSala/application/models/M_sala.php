...
class M_sala extends CI_Model
{
    ...
    */
    ...
    public function inserir($codigo, $descricao, $andar, $capacidade){
        try {
            //Verifico se a asala ja está cadastrada
        ...
        //acima oeka estrutura de decisão if
        return $dados;
    }
    ...
    private function consultaSala($codigo){
        try {
            ...
            //Verificar se a consulta ocorreu com successo
    ...
    public function desativar($codigo){
        ...
        try{
            //Verifica se a sala ja está cadastrada
            $retornoConsulta = $this->consultaSala($codigo);
        ...
        //Envia o array $dados com as informações tratada
        //acima pela estrutura de decisão if
        return $dados;
    }
}
