...
class Horario extends CI_Controller {
    ...
    14 - Data Final menor que a Data Final
    ...
    public function inserir(){
        ...
        try {
            ...
            if (verificarParam($resultado, $lista) != 1){
                ...
                $erros[] = ['codigo' => 99, 'msg' => 'Campos inexistentes no FrontEnd.'];
            }else{
    ...
    public function consultar(){
        ...
        try{
            ...
            if (verificarParam($resultado, $lista) != 1){
                ...
                //validando se a hora inicial não é maior que a final
                if($retornoComparacaoHoras['codigoHelper'] != 0) {
                    $erros[] = ['codigo' => $retornoComparacaoHoras['codigoHelper'],
                                'campo' => 'Hora Inicial e Hora Final',
                                'msg' => $retornoComparacaoHoras['msg']];
        ...
        //Monta retorno único
        if ($sucesso == true){
            $retorno = ['sucesso' => $sucesso, 'codigoo' => $resBanco['codigo'],
                        'msg' => $resBanco['msg'],
