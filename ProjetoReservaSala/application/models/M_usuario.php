...
class M_usuario extends CI_Model
{
    ...
    */
    ...
    public function inserir($nome, $email, $usuario, $senha){
        try{
            ...
            if($retornoUsuario['codigo'] == 4){
                ...
                $this->db->query("insert tbl_usuario (nome, email, usuario, senha)
    ...
    public function consultar($nome, $email, $usuario){
        ...
        // * Para todos us usuários;
        // * Para um determinado usuário;
        // * Para nomes de usuário;
        //===============================================

        try{
            //Quey para consultar dados de acordo com parâmetros passados
            $sql = "select id_usuari, nome, usuario, email
                    from tbl_usuario
                    where estatus != 'D'";
            ...
            if($retorno->num_rows() > 0){
                $dados = array(
                    'codigo' => 1,
                    'msg' => 'Consulta efetuado com sucesso',
                    'dados' => $retorno->resulta()
                );
            }else {
                $dados = array(
                    'codigo' => 6,
