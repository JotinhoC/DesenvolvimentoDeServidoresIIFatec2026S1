...
<html lang="pt-br">
    <head>
        ...
        <link rel="stylesheet" href="../../ProjetoReservaSala/assets/css/styleCadastro.css">
    ...
    <body>
        <header>
            <div id="headerMenu">
                <a href="../Funcoes/indexPagina">
                    <h1 id="headerTitle">Mapeamento da Salas</h1>
                </a>
                <nav class="navbar navbar-expand-lg navbar-dark">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item"><a class="nav-link" href="../funcoes/abreRelatorio">Relatatório</a></li>
                        </ul>
                    </div>
                </nav>
            </div>
        ...
        <main>
            <section class="secao4" id="cadastroProfessor">
                <div id="btnCadastroModal">
                    ...
                    <button class="btn btn-outline-primary btnAcao" id="botaoModal" type="button" data-toggle="modal"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <select name="tipo" id="tipo" class="form-control" required>
                                                ...
                                                <option value="F">Carta Convite</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
        ...
        <script src="../../ProjetoReservaSala/assets/js/jquery-3.6.0.min.js" type="text/javascript"></script>
        <script src="../../ProjetoReservaSala/assets/js/bootstrap.min.js"  type="text/javascript"></script>
        <script src="../../ProjetoReservaSala/assets/js/sweetalert2.all.min.js"  type="text/javascript"></script>
        ...
        <script>
            ...
            function openEditModal(codigo, button){
                //A linha do botao clicando
                const row = button.closest('tr');
                //Pegar os dados da linha
                const nome = row.cells[0].innerText; //Código da sala
                const cpf = row.cells[1].innerText; //Descrição da sala
                const tipo = row.cells[2].innerText.charAt(0); //Pega o andar, ajustado para o valor numérico
            ...
            async function editarSala() {
                ...
                try {
                    ...
                    $('#cadastroProfessorModal').modal('hide');
                    carregarDados(); //Atualiza a tabela com novos dados
                } catch (error) {
            ...
            function filtrarTabela() {
                ...
                for (let i = 0; i < linhas.length; i++) {
                    const colSala = linhas[i].getElementsByTagName("td")[0]; //Coluna do nome do professor
                    const colCpf = linhas[i].getElementsByTagName("td")[1]; //Coluna do tipo de cpf
                    const colTipo = linhas[i].getElementsByTagName("td")[2]; //Coluna do tipo do professor

                    if (colProfessor) {
                        const salaTexto = colProfessor.textContent || colProfessor.innerText;
