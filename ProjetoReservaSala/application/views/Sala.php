        ...
        <script>
            ...
            function filtrarTabela() {
                ...
                for (let i = 0; i < linhas.length; i++) {
                    ...
                    const colDescricao = linhas[i].getElementsByTagName("td")[1]; //Coluna de descrição da editarSala
                    ...
                    if (colSala || colDescricao) {
                        ...
                        if (salaTexto.toLowerCase().indexOf(filter) > -1 || descricaoText.toLowerCase().indexOf(filter) > -1) {
